...
class payment_status extends StatefulWidget {
  ...
  @override
  State<payment_status> createState() => _ClassNotifyState();
}

class _ClassNotifyState extends State<payment_status> {
                ...
                Row(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: Icon(Icons.payment,color: Colors.green,size: 28,),
                    ),
