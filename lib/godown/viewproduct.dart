                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    ...
                                    return  GestureDetector(
                                      onTap: (){
                                        ...
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>product_catagories(id:id)));
                                      },
                                      child: Container(
                                        ...
                                        child: Material(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Spacer(),
                                              Text(_loaddata[index]['categoryname'],textAlign: TextAlign.center,style: TextStyle(fontSize: 8,fontWeight: FontWeight.bold),),
