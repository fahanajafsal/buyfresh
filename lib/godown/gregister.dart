...
class gregister extends StatefulWidget {
  const gregister({Key? key}) : super(key: key);

  @override
  State<gregister> createState() => _gregisterState();
}
...
class _gregisterState extends State<gregister> {
  ...
  void registerUser()async {
    ...
    print("goddown data${data}");
    var res = await Api().authData(data,'api/goddown_register');
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(onPressed: ()
                {
                  ...
                  style: ElevatedButton.styleFrom(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(29.0)),primary: Colors.purple,fixedSize: Size(300, 57)),
