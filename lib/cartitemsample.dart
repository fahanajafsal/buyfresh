...
import 'package:buyfresh/cartmodel.dart';
import 'package:buyfresh/placeorder.dart';
import 'package:buyfresh/user/EmptyCartImage.dart';
...
class _cartitemsampleState extends State<cartitemsample> {
  ...
  _deleteData(int id) async {
    var res = await Api().deleteData('/api/deletecart/' + cart_id.toString());
